...
wire signed  [5+8-1:0] mul[32-1:0];
genvar i;
...
generate
    for(i = 0; i < 32; i = i + 1)begin
        ...
        assign mul[i] <= w_vec[i]*a_vec[i];
    end
endgenerate


reg signed [14-1:0] ad0[16-1:0];
wire signed [15-1:0] ad1[8-1:0];
wire  signed [16-1:0] ad2[4-1:0];
...
generate
    for(st2 = 0; st2 < 4; st2 = st2 + 1) begin
        assign ad2[st2] <= ad1[st2*2+1] + ad1[st2*2];
    end
endgenerate
